...
def send_reset_email(email, reset_link):
    ...
    msg["To"] = email
    msg.set_content(
        f"Merhaba,\n\nŞifreni sıfırlamak için aşağıdaki bağlantıya tıklayabilirsin (1 saat geçerlidir):\n{reset_link}\n\nCampusHub Ankara Ekibi"
    )
...
async def sifremi_unuttum(request):
    ...
    try:
        ...
        return json({"basarili": True, "mesaj": "Şifre sıfırlama bağlantısı e-posta adresinize gönderildi."})
